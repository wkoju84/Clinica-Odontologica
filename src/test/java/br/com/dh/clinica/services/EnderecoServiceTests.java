...
public class EnderecoServiceTests {
    ...
    public void findAllDeveriaRetornarUmaLista(){
        List<EnderecoDto> resultado = service.buscarTodos();
    ...
    public void findByIdDeveriaRetornarUmRegistroDoBD(){
        EnderecoDto resultado = service.buscarPorId(idExistente);
        Assertions.assertNotNull(resultado);
    }
    ...
    public void updateDeveriaAtualizarUmRegistro(){
        EnderecoDto resultado = service.atualizar(idExistente, dto);
        Assertions.assertNotNull(resultado);
    }
